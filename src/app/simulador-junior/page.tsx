    ...
    <div className="pt-32 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="bg-white rounded-xl shadow-md p-8 md:p-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-6">Simulador Junior</h1>
          <p className="text-xl text-gray-600 mb-8">
            Esta sección está en desarrollo. Próximamente encontrarás aquí nuestro simulador de programación para
            principiantes.
          </p>
